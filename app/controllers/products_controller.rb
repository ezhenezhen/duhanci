  ...
  def parse_products_information
    ...
    while i < links.size
      begin
        ...
        description = data.at_css('.full .text').text
        ...
        unless javascript.nil?
          ...
          while j < javascript.css('.opselect-li').size
            unless javascript.css('.opselect-li')[j].nil?
              ...
              if parent.nil?
                product = Product.create(:name => name, :product_type => type, :price => price, :description => description, :available => available, :size => size, :year => year, :country => country, :sex => sex, :family => family, :upnotes => upnotes, :heart => heart, :base => base)
                parent = product.id
              else
                product = Product.create(:name => name, :product_type => type, :price => price, :description => description, :available => available, :size => size, :year => year, :country => country, :sex => sex, :family => family, :upnotes => upnotes, :heart => heart, :base => base, :parent_id => parent)
              end
